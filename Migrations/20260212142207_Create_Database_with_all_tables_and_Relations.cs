...
{
    /// <inheritdoc />
    public partial class Create_Database_with_all_tables_and_Relations : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Sign_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    name_ar = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    name_en = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    type = table.Column<int>(type: "int", nullable: false),
                    Video_path = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    Animation_path = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    Duration = table.Column<int>(type: "int", nullable: false),
                    Fps = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tb_Signs", x => x.Sign_id);
                });
